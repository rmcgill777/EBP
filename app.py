...
""", unsafe_allow_html=True)
    ...
    # 👇 THIS MUST BE INDENTED (inside the expander)
...
- Straus, S. E., Glasziou, P., Richardson, W. S., & Haynes, R. B. (2018). *Evidence-based medicine: How to practice and teach EBM* (5th ed.). Elsevier Health Sciences.  
...
- Youngstrom, E. A., & Van Meter, A. (2016). *Empirically supported assessment of children and adolescents.* Clinical Psychology: Science and Practice, 23(4), 327–347.  

- Youngstrom, E. A., & Prinstein, M. J. (2020). *Introduction to evidence based assessment: A recipe for success.* In E. A. Youngstrom, M. J. Prinstein, E. J. Mash, & R. A. Barkley (Eds.), *Assessment of disorders in childhood and adolescence* (5th ed., pp. 3–29). Guilford Press.  
        """)
# -------------------------
# INPUTS
# -------------------------
