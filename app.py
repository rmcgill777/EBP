...
- Sackett, D. L., Rosenberg, W. M. C., Gray, J. A. M., Haynes, R. B., & Richardson, W. S. (1996). *Evidence based medicine: What it is and what it isn't.*  
  British Medical Journal, 312(7023), 71-72.  

- Straus, S. E., Glasziou, P., Richardson, W. S., & Haynes, R. B. (2018). *Evidence-based medicine: How to practice and teach EBM* (5th ed.).  
  Elsevier Health Sciences.  

- Youngstrom, E. A., Choukas-Bradley, S., Calhoun, C. D., & Jensen-Doss, A. (2015). *Clinical guide to the evidence-based assessment approach to diagnosis and treatment.*  
...
- Youngstrom, E. A., & Prinstein, M. J. (2020). *Introduction to evidence based assessment: A recipe for success.*  In E. A. Youngstrom, M. J. Prinstein, E. J. Mash, & R. A. Barkley (Eds.),  
  *Assessment of disorders in childhood and adolescence* (5th ed., pp. 3-29). Guilford Press.  
    """)
